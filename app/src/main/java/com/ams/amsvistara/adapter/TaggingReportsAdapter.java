...
import com.ams.amsvistara.databinding.AdapterTaggingReportsItemBinding;
...
import com.ams.amsvistara.viewmodel.TaggingReportsItemViewModel;

import java.util.ArrayList;
import java.util.List;
import java.util.Locale;

public class TaggingReportsAdapter extends RecyclerView.Adapter<TaggingReportsAdapter.ViewHolder> implements  Filterable {

    private List<ReportItems> dataModelList;
    private List<ReportItems> listFiltered;
    private Context context;
    private TaggingReportsClickListener listener;



    public TaggingReportsAdapter(List<ReportItems> dataModelList, Context ctx, TaggingReportsClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent,
                                                            int viewType) {
        AdapterTaggingReportsItemBinding binding = DataBindingUtil.inflate(
                LayoutInflater.from(parent.getContext()),
                R.layout.adapter_tagging_reports_item, parent, false);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        TaggingReportsItemViewModel model = new TaggingReportsItemViewModel();
        model.setValue(item);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        AdapterTaggingReportsItemBinding binding;

        ViewHolder(AdapterTaggingReportsItemBinding binding) {
