...
import com.ams.amsvistara.adapter.SubLocDialogListAdapter;
...
public class SubLocationListExcessDialog extends Dialog implements SubLocDialogClickListener {

    private RecyclerView list;
    private TextView txtTitle;
    //private EditText filterText = null;
    private SubLocDialogListAdapter adapter = null;
    private static final String TAG = "PvModels";
    private Context mContext;
    private ExcessAssetViewModel viewModel;

    public SubLocationListExcessDialog(Context context, ArrayList<SubLocationMasters> pvModels, ExcessAssetViewModel viewModel) {
        super(context);
        setContentView(R.layout.search_list_dialog);
        this.viewModel = viewModel;
        txtTitle = (TextView) findViewById(R.id.txtTitle);
        txtTitle.setText("SUB LOCATION");
        mContext = context;
      /*  filterText = (EditText) findViewById(R.id.etxtSearch);
        ...
        adapter = new SubLocDialogListAdapter(pvModels, context, this);
    ...
    @Override
    public void cardClicked(SubLocationMasters f) {
        Log.d(TAG, "Selected Item is = " + f);
        viewModel.SubLocation.setValue(f.SubLocationName);
        viewModel.SubLocationID.setValue(f.SubLocationID);
