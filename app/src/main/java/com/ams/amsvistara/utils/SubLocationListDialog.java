...
public class SubLocationListDialog extends Dialog implements SubLocDialogClickListener {
    ...
    public SubLocationListDialog(Context context, ArrayList<SubLocationMasters> pvModels, PVDetailViewModel viewModel) {
        super(context);
