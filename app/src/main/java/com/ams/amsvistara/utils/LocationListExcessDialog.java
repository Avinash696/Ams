...
public class LocationListExcessDialog extends Dialog implements LocDialogClickListener {
    ...
    public LocationListExcessDialog(Context context, ArrayList<LocationMasters> pvModels, ExcessAssetViewModel viewModel) {
        super(context);
